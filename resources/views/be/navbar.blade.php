...
<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
            ...
            <div class="m-header">
                ...
                <a href="#!" class="b-brand">
                    ...
                    <img src="back-end/images/logo.png" alt="" class="logo">
                    <img src="back-end/images/logo-icon.png" alt="" class="logo-thumb">
                </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right notification">
                                ...
                                <ul class="noti-body">
                                    ...
                                    <li class="notification">
                                        <div class="media">
                                            <img class="img-radius" src="back-end/images/user/avatar-1.jpg" alt="Generic placeholder image">
                                    ...
                                    <li class="notification">
                                        <div class="media">
                                            <img class="img-radius" src="back-end/images/user/avatar-2.jpg" alt="Generic placeholder image">
                                            <div class="media-body">
