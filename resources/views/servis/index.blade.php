...
<div class="container-fluid bg-light service py-5">
    <div class="container py-5">
        ...
        <div class="row g-4"> @foreach ($berita as $item)
            <div class="col-lg-6">
                <div class="row g-4">
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center justify-content-between bg-white border border-primary rounded p-4 pe-0">

                            {{-- Konten Teks --}}
                            <div class="service-content text-center w-75">
                                <h3 class="mb-1 text-dark fw-bold" style="font-size: 50px;">
                                    {{ $item->judul }}
                                </h3>
                                <p class="mb-2 text-secondary" style="font-size: 20px;">
                            ...
                            <div class="service-icon p-2 ps-3">
                                <img src="{{ asset('storage/'.$item->foto) }}" style="width: 100%; height: 250px;" class="img-fluid rounded">
                            </div>
                        </div>
                    </div>
                </div>
